        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Galleries_Cities_CityId",
                        column: x => x.CityId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipsAndTricks = table.Column<string>(type: "text", nullable: false),
                    CityId = table.Column<int>(type: "integer", nullable: false),
                    GalleryId = table.Column<int>(type: "integer", nullable: false),
                    CreatedByArtistId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Artworks_Users_CreatedByArtistId",
                        column: x => x.CreatedByArtistId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Artworks_Users_PostedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Artworks_CityId",
                table: "Artworks",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_Artworks_CreatedByArtistId",
                table: "Artworks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Artworks_PostedByUserId",
                table: "Artworks",
